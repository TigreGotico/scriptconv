...
``africa_g2p/`` used to be vendored here. africa-g2p is published on PyPI, so
it is an optional extra now (``scriptconv[africa]``), and this project does not
vendor what PyPI publishes.
